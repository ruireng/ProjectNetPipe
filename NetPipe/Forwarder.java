...
public class Forwarder {
    ...
    // if a socket is given as argument, shut down output to the socket after end of file
    ...
    // start two forwarder threads, one in each direction, and wait for them to complete
